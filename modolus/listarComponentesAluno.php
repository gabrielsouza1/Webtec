...
$sql = "SELECT * FROM componentes WHERE ano = '$ano' ORDER BY nome;";
...
<div class="page-header">
    <h1>Lista de Componentes do Módulo <?= $ano . "º" ?></h1>
</div>
            ...
            <tr>
                ...
                <td class="actions">
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal"
                            data-target="#myModal<?= $dados['idconteudo'] ?>">Visualizar
                    </button>
                </td>
            </tr>

            <!-- Modal -->
            <div class="modal fade" id="myModal<?= $dados['idcomponente'] ?>" tabindex="-1" role="dialog"
